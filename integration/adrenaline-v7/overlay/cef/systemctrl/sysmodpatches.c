...
void PatchImposeDriver(u32 text_addr) {
	...
	SceAdrenaline *adrenaline = (SceAdrenaline *)ADRENALINE_ADDRESS;
	if (!adrenaline->adr_id && config_booter.psbutton != 2) _sw(0, text_addr + 0x968);
...
void SetSpeed(int cpu, int bus) {
	...
	if (cpu == 20  || cpu == 50 || cpu == 75 || cpu == 100 || cpu == 111 || cpu == 122 || cpu == 133 || cpu == 166 || cpu == 200 || cpu == 222 || cpu == 266 || cpu == 288 || cpu == 300 || cpu == 333) {
