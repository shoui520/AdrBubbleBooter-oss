...
INCLUDE_EXTERN_RESOURCE(kd_booter_prx);
...
INCLUDE_EXTERN_RESOURCE(kd_pspbtbnf_bin);
...
static ScePspemuFlash0Package custom_package[] = {
  FLASH0_FILE("/kd/booter.prx",   		  kd_booter_prx),
  ...
  FLASH0_FILE("/kd/pspbtbnf.bin",         kd_pspbtbnf_bin),
